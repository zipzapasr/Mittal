        ...
        <div class="col-lg-12">
            <div class="white_card card_height_100 mb_30">
                <div class="white_card_body row" >
                    ...
                    <form method="POST" action="{{ route('update.godown.cementOut', ['user' => $user, 'cementOut' => $cement_out->id]) }}" class="col-md-6">
                        @csrf
                        ...
                        <div class="mb_30">
                            <label style="width: 100%" for="">
                                ...
                                <div class=" mb-0">
                                    <input type="number" min="0" class="form-control" name="bags" value="{{ $cement_out->bags ?? 0 }}" id="bags" placeholder="Num. of Bags" required>
                                </div>
                                @if($errors->has('bags'))
