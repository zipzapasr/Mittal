    ...
    <div class="col-lg-12">
        ...
        <div class="white_card card_height_100 mb_30">
            ...
            <div class="white_card_body">
                ...
                <h2 style="padding: 20px 0px" id="contractorName">Petty Contractor Report</h2>
                ...
                if (contractor && from && to) {
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            ...
                            $('#contractorName').append('Petty Contractor Report: ' + '<span class="text-success">' + res.contractor_name + '</span>')
