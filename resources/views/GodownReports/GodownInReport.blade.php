    ...
    <div class="col-lg-12">
        ...
        <div class="white_card card_height_100 mb_30">
            ...
            <div class="white_card_body">
                ...
                <h2 style="padding: 20px 0px" id="siteName">Cement Ins By Godown Report</h2>
        ...
        $('#formSubmitBtn').click(function() {
            ...
            if (from && to) {
                ...
                $.ajax({
                    ...
                    url: "{{route('filter.godownInReport')}}",
                    ...
                    success: function(res) {
                        ...
                        for (var ind in res.cement_ins) {
                            //console.log(ind)
                            $('#tbody').append(`<tr><th>${res.cement_ins[ind].date}</th><th>${res.cement_ins[ind].bags}</th><th>${res.cement_ins[ind].get_to_site.site_name}</th><th>${res.cement_ins[ind].remark}</th></tr>`)
                        }
