        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="">{{--hidden fixed  px-6 py-4 sm:block--}}
                    @auth
                        <a href="{{ url('/home') }}" class="text-lg" style="background-color: blue; color: white; padding: 2px;  border: 2px solid white; border-radius: 2px 2px;">Home</a>
                    @else
                        <a href="{{ route('login') }}" class="text-lg" style="background-color: blue; color: white; padding: 2px;  border: 2px solid white; border-radius: 2px 2px;">Log in</a>
