    ...
    <div class="container" style="margin-top:70px;">
        ...
        @foreach($entriesByDate as $date => $entries)
            <div>
                ...
                @endphp
                <h2 class="mt-2">Site Entries {{ $displayDate }}</h2>
                {{-- {{dump($entries)}} --}}
                ...
                @php
                    ...
                    foreach($entries as $entry){
                        //dump('status', $entry->status);
                        array_push($statuses, $entry->status);
                    }
                    //dump($statuses);
                                        ...
                                        <p>
                                            ...
                                            @foreach($images as $img)
                                                ...
                                                <a target="_blank"  href="{{'/mittal/storage/app/public/'.$img}}">
                                                    ...
                                                    <img src="{{'/mittal/storage/app/public/'.$img}}" alt="" style="width:35px;height:35px;">
